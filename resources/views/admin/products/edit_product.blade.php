        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <select name="category_id" id="category_id" style="width:220px;" value="{{ old('category_id') }}">
              ...
              <div class="control-group">
                ...
                <img style="width:40px" src="{{ asset('/images/backend_images/products/thumb/'.$productDetails->image)}}" alt="">
                <a class="btn btn-warning btn-sm" href="{{ url('/admin/delete-product-image/'.$productDetails->id)}}">Delete</a>
                @endif
                </div>
